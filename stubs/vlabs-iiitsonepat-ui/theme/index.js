...
function makeShades(r1, g1, b1, r12, g12, b12) {
  ...
  for (let i = 1; i <= 12; i++) {
    ...
    const b = b1 + (b12 - b1) * t;
    shades[`${i}`] =
      `color(display-p3 ${r.toFixed(3)} ${g.toFixed(3)} ${b.toFixed(3)})`;
  }
  return shades;
}
...
const THEME_LIGHT = {
  ...
  color: {
    ...
    blue8: BLUE_SHADES[8],
    blue9: BLUE_SHADES[9],
    blue10: BLUE_SHADES[10],
    blue11: BLUE_SHADES[11],
    blue12: BLUE_SHADES[12],
    // Gray
    gray1: GRAY_SHADES[1],
    gray2: GRAY_SHADES[2],
    gray3: GRAY_SHADES[3],
    ...
    orange1: ORANGE_SHADES[1],
    orange2: ORANGE_SHADES[2],
    orange3: ORANGE_SHADES[3],
    orange4: ORANGE_SHADES[4],
    orange5: ORANGE_SHADES[5],
    orange6: ORANGE_SHADES[6],
    orange7: ORANGE_SHADES[7],
    orange8: ORANGE_SHADES[8],
    orange9: ORANGE_SHADES[9],
    orange10: ORANGE_SHADES[10],
    orange11: ORANGE_SHADES[11],
    orange12: ORANGE_SHADES[12],
    // Purple
    purple1: PURPLE_SHADES[1],
    purple2: PURPLE_SHADES[2],
    purple3: PURPLE_SHADES[3],
    purple4: PURPLE_SHADES[4],
    purple5: PURPLE_SHADES[5],
    purple6: PURPLE_SHADES[6],
    purple7: PURPLE_SHADES[7],
    purple8: PURPLE_SHADES[8],
    purple9: PURPLE_SHADES[9],
    purple10: PURPLE_SHADES[10],
    purple11: PURPLE_SHADES[11],
    purple12: PURPLE_SHADES[12],
    // Pink
    pink1: PINK_SHADES[1],
    pink2: PINK_SHADES[2],
    pink3: PINK_SHADES[3],
    ...
    pink8: PINK_SHADES[8],
    pink9: PINK_SHADES[9],
    pink10: PINK_SHADES[10],
    pink11: PINK_SHADES[11],
    pink12: PINK_SHADES[12],
    // Green
    green1: GREEN_SHADES[1],
    green2: GREEN_SHADES[2],
    green3: GREEN_SHADES[3],
    green4: GREEN_SHADES[4],
    green5: GREEN_SHADES[5],
    green6: GREEN_SHADES[6],
    green7: GREEN_SHADES[7],
    green8: GREEN_SHADES[8],
    green9: GREEN_SHADES[9],
    green10: GREEN_SHADES[10],
    green11: GREEN_SHADES[11],
    green12: GREEN_SHADES[12],
    // Turquoise (teal)
    turquoise: TURQUOISE_SHADES[9],
    turquoise1: TURQUOISE_SHADES[1],
    turquoise2: TURQUOISE_SHADES[2],
    turquoise3: TURQUOISE_SHADES[3],
    turquoise4: TURQUOISE_SHADES[4],
    turquoise5: TURQUOISE_SHADES[5],
    turquoise6: TURQUOISE_SHADES[6],
    turquoise7: TURQUOISE_SHADES[7],
    turquoise8: TURQUOISE_SHADES[8],
    turquoise9: TURQUOISE_SHADES[9],
    turquoise10: TURQUOISE_SHADES[10],
    turquoise11: TURQUOISE_SHADES[11],
    turquoise12: TURQUOISE_SHADES[12],
    // Amber
    amber: AMBER_SHADES[9],
    amber1: AMBER_SHADES[1],
    amber2: AMBER_SHADES[2],
    amber3: AMBER_SHADES[3],
    amber4: AMBER_SHADES[4],
    amber5: AMBER_SHADES[5],
    amber6: AMBER_SHADES[6],
    amber7: AMBER_SHADES[7],
    amber8: AMBER_SHADES[8],
    amber9: AMBER_SHADES[9],
    amber10: AMBER_SHADES[10],
    amber11: AMBER_SHADES[11],
    amber12: AMBER_SHADES[12],
    // Yellow
    yellow1: YELLOW_SHADES[1],
    yellow2: YELLOW_SHADES[2],
    yellow3: YELLOW_SHADES[3],
    yellow4: YELLOW_SHADES[4],
    yellow5: YELLOW_SHADES[5],
    yellow6: YELLOW_SHADES[6],
    yellow7: YELLOW_SHADES[7],
    yellow8: YELLOW_SHADES[8],
    yellow9: YELLOW_SHADES[9],
    yellow10: YELLOW_SHADES[10],
    yellow11: YELLOW_SHADES[11],
    yellow12: YELLOW_SHADES[12],
    // Violet
    violet1: VIOLET_SHADES[1],
    violet2: VIOLET_SHADES[2],
    violet3: VIOLET_SHADES[3],
    violet4: VIOLET_SHADES[4],
    violet5: VIOLET_SHADES[5],
    violet6: VIOLET_SHADES[6],
    violet7: VIOLET_SHADES[7],
    violet8: VIOLET_SHADES[8],
    violet9: VIOLET_SHADES[9],
    violet10: VIOLET_SHADES[10],
    violet11: VIOLET_SHADES[11],
    violet12: VIOLET_SHADES[12],
  ...
  accent: {
    ...
    accent1: BLUE_SHADES[1],
    accent2: BLUE_SHADES[2],
    accent3: BLUE_SHADES[3],
    accent4: BLUE_SHADES[4],
    accent5: BLUE_SHADES[5],
    accent6: BLUE_SHADES[6],
    accent7: BLUE_SHADES[7],
    accent8: BLUE_SHADES[8],
    accent9: BLUE_SHADES[9],
    accent10: BLUE_SHADES[10],
    accent11: BLUE_SHADES[11],
    accent12: BLUE_SHADES[12],
  },
  ...
  boxShadow: {
    ...
    light:
      "0px 2px 4px 0px color(display-p3 0 0 0 / 0.12), 0px 0px 4px 0px color(display-p3 0 0 0 / 0.08)",
    strong:
      "2px 4px 16px 0px color(display-p3 0 0 0 / 0.20), 0px 2px 4px 0px color(display-p3 0 0 0 / 0.12)",
    underline: "0px 1px 0px 0px color(display-p3 0 0 0 / 0.20)",
    superHeavy:
      "0px 0px 8px 0px color(display-p3 0 0 0 / 0.20), 0px 8px 64px -16px color(display-p3 0 0 0 / 0.30)",
  },
