...
export const exp8085SqrtExperiment: ExperimentDefinition = {
  ...
  description: "The integer square root of N is the largest integer k such that k² ≤ N. A clever mathematical property states that N = 1 + 3 + 5 + … + (2k−1) — that is, N is the sum of the first k odd numbers. Theref",
  labType: 'code',
  components: [],
