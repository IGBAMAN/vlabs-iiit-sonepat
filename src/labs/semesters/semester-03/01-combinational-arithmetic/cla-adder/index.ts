...
export const claAdderExperiment: ExperimentDefinition = {
  ...
  description: "A Ripple Carry Adder (RCA) chains n full adders in series: each stage must wait for the carry from the previous stage before it can compute its sum and carry. The total propagation delay is $n \\times ",
  labType: 'text',
  components: [],
