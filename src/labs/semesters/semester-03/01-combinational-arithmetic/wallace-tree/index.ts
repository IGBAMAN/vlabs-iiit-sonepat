...
export const wallaceTreeExperiment: ExperimentDefinition = {
  ...
  description: "The Wallace Tree multiplier is a hardware multiplication algorithm designed to minimize the delay of computing the product of two n-bit numbers. It achieves O(log n) gate depth (vs O(n) for the naive ",
  labType: 'text',
  components: [],
