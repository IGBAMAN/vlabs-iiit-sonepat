...
export const memoryDesignExperiment: ExperimentDefinition = {
  ...
  description: "Computer memory is organised into a flat array of byte-addressable locations. Each location holds 8 bits (1 byte) and is uniquely identified by a binary address. This simulator models a 256-byte memor",
  labType: 'simulation',
  components: [],
