...
export const cpuDesignExperiment: ExperimentDefinition = {
  ...
  description: "The Central Processing Unit (CPU) operates by repeatedly performing a three-stage cycle: Fetch, Decode, and Execute. This is the fundamental operational loop of every stored-program computer.",
  labType: 'simulation',
  components: [],
