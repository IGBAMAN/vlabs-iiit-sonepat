...
export const shiftRegisterExperiment: ExperimentDefinition = {
  ...
  description: "Load data serially into a 74HC273 8-bit register and observe all 8 parallel outputs on LEDs. Data appears on Q0–Q7 on each rising clock edge.",
  truthTable: {
      inputs: [
        "CLK_edge",
        "D[7:0]",
