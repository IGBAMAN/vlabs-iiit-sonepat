...
export const encoder4to2Experiment: ExperimentDefinition = {
  ...
  description: "A 4-to-2 encoder takes 4 input lines (only one HIGH at a time) and outputs a 2-bit binary code. Input I0→00, I1→01, I2→10, I3→11. Built from two OR gates.",
  truthTable: {
      inputs: [
        "I3",
        "I2",
