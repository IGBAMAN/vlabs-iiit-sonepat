...
export const fullAdderExperiment: ExperimentDefinition = {
  id: 'full-adder',
  title: "Full Adder",
  description: "A full adder adds three bits: A, B and a carry-in (Cin). It produces a Sum and a Carry-out. Built from two XOR gates, two AND gates, and one OR gate.",
  truthTable: {
      inputs: [
        "A",
        "B",
