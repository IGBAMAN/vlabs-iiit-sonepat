...
export const demux1to2Experiment: ExperimentDefinition = {
  ...
  description: "A 1-to-2 DEMUX routes a single input I to one of two outputs (Y0 or Y1) based on select line S. S=0 → Y0=I, Y1=0. S=1 → Y0=0, Y1=I. Built from one NOT and two AND gates.",
  truthTable: {
      inputs: [
        "S",
        "I",
