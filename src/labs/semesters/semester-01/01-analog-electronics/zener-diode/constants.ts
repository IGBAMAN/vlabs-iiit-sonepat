...
export const M = {
  r1_p1: [resistorP1(R1_COL, R1_ROW)[0], TOP_Y + HOVER, resistorP1(R1_COL, R1_ROW)[2]] as [
    number,
    number,
    number,
  ],
  r1_p2: [resistorP2(R1_COL, R1_ROW)[0], TOP_Y + HOVER, resistorP2(R1_COL, R1_ROW)[2]] as [
    number,
    number,
    number,
  ],
  zd_anode: [ledAnode(ZD_COL, ZD_ROW)[0], TOP_Y + HOVER, ledAnode(ZD_COL, ZD_ROW)[2]] as [
    number,
    number,
    number,
  ],
  zd_cathode: [ledCathode(ZD_COL, ZD_ROW)[0], TOP_Y + HOVER, ledCathode(ZD_COL, ZD_ROW)[2]] as [
    number,
    number,
    number,
  ],
  vcc_rail: [railPos(R1_COL, 'vcc_top')[0], TOP_Y + HOVER, railPos(R1_COL, 'vcc_top')[2]] as [
    number,
    number,
    number,
  ],
  ...
  vm_neg: [holePos(ZD_COL + 1, 'a')[0], TOP_Y + HOVER, holePos(ZD_COL + 1, 'a')[2]] as [
    number,
    number,
    number,
  ],
