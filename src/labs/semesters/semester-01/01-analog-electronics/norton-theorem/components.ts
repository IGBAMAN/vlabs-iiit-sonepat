...
export const components: ComponentInstance[] = [
  ...
  { id: 'w_r1_junc',  type: 'wire', color: 'orange', from: { component: 'r1', end: 'p2' }, to: { board: 'bb', col: 7, row: 'c' } },
  { id: 'w_r2_gnd',   type: 'wire', color: 'black',  from: { component: 'r2', end: 'p2' }, to: { board: 'bb', rail: 'gnd_top', col: 12 } },
  { id: 'w_junc_rload', type: 'wire', color: 'green', from: { board: 'bb', col: 7, row: 'b' }, to: { component: 'r_load', end: 'p1' } },
