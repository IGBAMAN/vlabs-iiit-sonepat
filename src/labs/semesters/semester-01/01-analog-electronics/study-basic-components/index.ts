...
export const StudyBasicComponentsCircuit = buildCircuit(studyBasicComponentsExperiment);
export const StudyBasicComponentsContent = buildLabContent(studyBasicComponentsExperiment);
