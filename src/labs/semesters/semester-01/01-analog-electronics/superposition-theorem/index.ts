...
export const SuperpositionTheoremCircuit = buildCircuit(superpositionTheoremExperiment);
export const SuperpositionTheoremContent = buildLabContent(superpositionTheoremExperiment);
