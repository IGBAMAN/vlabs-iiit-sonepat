...
// ── Types ─────────────────────────────────────────────────────────────────
type Operation =
  "ADD" | "SUB" | "AND" | "OR" | "XOR" | "NOT A" | "NAND" | "NOR";
  ...
  return (
    <div style={S.root}>
      ...
      <div style={S.row}>
        ...
        <span style={S.hexDecLabel}>
          = <span style={S.hexVal}>{toHex(aVal)}</span> = {aVal}
        </span>
      </div>
      ...
      <div style={S.row}>
        ...
        <span style={S.hexDecLabel}>
          = <span style={S.hexVal}>{toHex(bVal)}</span> = {bVal}
        </span>
      </div>
      ...
      <div style={S.row}>
        ...
        <span style={S.hexDecLabel}>
          = <span style={S.hexVal}>{toHex(result.value)}</span> = {result.value}
        </span>
        {result.carry > 0 && (
      ...
      <div style={{ ...S.row, marginTop: 8 }}>
        ...
        <div>
          <span style={S.flagPill(result.flags.Z === 1, "#4dabf7")}>
            Z={result.flags.Z}
          </span>
          <span style={S.flagPill(result.flags.S === 1, "#f06595")}>
            S={result.flags.S}
          </span>
          <span style={S.flagPill(result.flags.CY === 1, "#ff6b6b")}>
            CY={result.flags.CY}
          </span>
          <span style={S.flagPill(result.flags.OV === 1, "#ffa94d")}>
            OV={result.flags.OV}
          </span>
          <span style={S.flagPill(result.flags.P === 1, "#51cf66")}>
            P={result.flags.P}
          </span>
        </div>
      </div>
      ...
      {/* Equation */}
      <div style={S.eqLine}>Binary: {eqStr}</div>
    </div>
  );
}
