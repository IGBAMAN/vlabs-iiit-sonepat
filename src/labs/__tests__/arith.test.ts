...
describe("Addition", () => {
  it("2+3=5 (4-bit)", () =>
    expect(opAdd(n(2, 4), n(3, 4), 4)).toEqual(n(5, 4)));
  it("7+7=14 (4-bit)", () =>
    expect(opAdd(n(7, 4), n(7, 4), 4)).toEqual(n(14, 4)));
  it("15+1=0 (wraps)", () =>
    expect(opAdd(n(15, 4), n(1, 4), 4)).toEqual(n(0, 4)));
...
describe("Multiplication", () => {
  it("3×4=12 (8-bit)", () =>
    expect(opMul(n(3, 8), n(4, 8), 8)).toEqual(n(12, 8)));
  it("2×7=14", () => expect(opMul(n(2, 4), n(7, 4), 8)).toEqual(n(14, 8)));
});

describe("Division", () => {
  it("10÷3=3 (integer)", () =>
    expect(opDiv(n(10, 8), n(3, 8), 8)).toEqual(n(3, 8)));
  it("÷0 = dividend", () =>
    expect(opDiv(n(7, 4), n(0, 4), 4)).toEqual(n(7, 4)));
});

describe("Modulo", () => {
  it("10%3=1", () => expect(opMod(n(10, 8), n(3, 8), 8)).toEqual(n(1, 8)));
  it("%0 = dividend", () =>
    expect(opMod(n(7, 4), n(0, 4), 4)).toEqual(n(7, 4)));
});

describe("Power", () => {
  it("2^8=256 (16-bit)", () =>
    expect(opPow(n(2, 16), n(8, 16), 16)).toEqual(n(256, 16)));
