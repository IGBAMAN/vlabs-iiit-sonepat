...
class StepBuilder {
  ...
  power(inputs: Record<string, 0 | 1>): this {
  ...
  supply(v: number): this {
    this._supplyVoltage = v;
    return this;
  }
  ...
  _toStep(): Step {
    return {
      ...
      ...(this._supplyVoltage !== undefined && {
        supplyVoltage: this._supplyVoltage,
      }),
...
export class CB {
  ...
  wireVcc(id: string, target: PinRef | number, color: WireColor = "red"): this {
    ...
    this._components.push({
      ...
      from: {
        board: "bb",
        rail: "vcc_top",
        col: typeof target === "number" ? target : 1,
      },
      to,
    });
    return this;
  ...
  wireLedToGnd(
    ...
    return this.wire(
      id,
      color,
      { led: ledId, end: "cathode" },
      { board: "bb", rail: "gnd_top", col },
    );
  }
...
export class StepBuilderChain {
  ...
  highlight(id: string): this {
    this._sb.highlight(id);
    return this;
  }
  power(i: Record<string, 0 | 1>): this {
    this._sb.power(i);
    return this;
  }
  reading(id: string, v: string): this {
    this._sb.reading(id, v);
    return this;
  }
  glow(id: string, b: number): this {
    this._sb.glow(id, b);
    return this;
  }
  supply(v: number): this {
