...
export const metadata = {
  ...
  description:
    "How to place components on the breadboard without column collisions.",
};
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Spare / interconnects</td>
          </tr>
          <tr>
            <td>
              <code>e</code>
            </td>
            <td>IC top-side pins (always use for gate mountedAt)</td>
          </tr>
          <tr>
            <td>
              <code>f–j</code>
            </td>
            <td>IC bottom-side pins (auto-managed by the DIP geometry)</td>
          </tr>
        </tbody>
      </table>
...
cols 26–29   R2 + LED2   (row c)`}</pre>
      ...
      <DocNav>
        <DocNavLink as={Link} href="/docs/steps" data-dir="prev">
          Steps &amp; highlighting
        </DocNavLink>
        <DocNavLink as={Link} href="/docs/types" data-dir="next">
          TypeScript types
        </DocNavLink>
      </DocNav>
    </Prose>
