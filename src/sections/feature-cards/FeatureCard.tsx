...
import { color, FONT_WEIGHT, fontFamily, radius, typeRampDeclarations } from '@/tokens';

function parseTypeRamp(ramp: Parameters<typeof typeRampDeclarations>[0]): React.CSSProperties {
