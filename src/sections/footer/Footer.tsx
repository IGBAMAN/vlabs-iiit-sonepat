        ...
        >
          ...
          <div className="flex flex-col gap-[calc(var(--spacing-base)*5)]">
            ...
            <div className="flex flex-col gap-[calc(var(--spacing-base)*3)]">
              ...
              <a className="text-[#6b6a68] font-[family-name:var(--font-sans),sans-serif] text-[15px] no-underline w-fit transition-colors duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] hover:text-[#111110]" href="#">Contributing</a>
              <a className="text-[#6b6a68] font-[family-name:var(--font-sans),sans-serif] text-[15px] no-underline w-fit transition-colors duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] hover:text-[#111110]" href="#">CONTRIBUTING.md</a>
            </div>
          </div>
        </div>
